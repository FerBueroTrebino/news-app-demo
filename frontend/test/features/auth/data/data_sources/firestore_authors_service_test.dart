// ignore_for_file: subtype_of_sealed_class — Firestore types are sealed; mocks are for unit tests only.
...
void main() {
  ...
  group('syncAuthorOnLogin', () {
    test('updates timestamps when author document already exists', () async {
